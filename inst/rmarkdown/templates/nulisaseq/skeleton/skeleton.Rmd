...
params:
  ...
  xmlFiles: !r c("20230519_NULISAseq_Data_etr_F2mHsrZe_output_TAP.xml", "20230519_NULISAseq_Data_etr_evhNCkFH_output_xml.xml")
...
##########################
if(multipleFiles==TRUE){
  detectability_data <- detectability_return_targets$Overall[,'all']
} else {
  detectability_data <- detectability_return_targets$`Plate  1`[,1]
}
