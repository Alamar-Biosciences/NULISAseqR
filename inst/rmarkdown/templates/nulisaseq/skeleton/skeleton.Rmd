...
params:
  ...
  dataDir: "."
  ## XML file names
  xmlFiles: !r c("20230522_NULISAseq_Data_etr_H4htpaIE_output_xml.xml","20230522_NULISAseq_Data_etr_rZ2fRDqC_output_xml.xml")
  dataRuns: NULL 
...
=======
  sampleGroupCovar: "CONDITION_1"
>>>>>>> 47bac7a (fix bugs in the detectability boxplot by sample group covar output file. also switch default XML to data that has the "CONDITION_1" filled in to test sampleGroupCovar functionality)
...
rowNameQC <- c()
QCSummary <- matrix(nrow=numFiles + 1, ncol=length(criteria$thresholds) + 1)
for (i in 1:numFiles){
...
```{r, out.width='100%', eval=(params$outIntraPlateNorm), fig.asp=(0.2*numFiles + 0.15), eval=indicatorSC}
