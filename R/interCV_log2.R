#' Calculate Inter-plate Coefficients of Variation for Log2-transformed Data
#'
#' Calculates CV% for the specified replicates across multiple plates. Assumes data is on
...
#' @export
#'
interCV_log2 <- function(data_list, 
                         samples,
                         aboveLOD=NULL,
