...
pandoc.list(c("ICRead_CV - Coefficient of Variation of internal control signal across all samples",
              "IPCRead_CV - Coefficient of Variation of the total assay signal across all samples",
              "IPCTarget_CV - Median Coefficient of Variation of all IPC targets",
              "Detectability - Percentage of targets that are detectable (target is considered detectable if > 50% samples have signal > LOD)",
              "MinReads - Minimum number of total Parseable Match reads (signal) for the experiment"
))
