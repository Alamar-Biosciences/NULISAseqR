...
params:
  ...
  Bridge: !r NULL
  ## directory where xml files are located relative to the Rmd file location
  dataDir: "../data"
  ...
  # a character vector of all the xml files to include in the analysis 
  xmlFiles: !r c("example1_no_nonmatching.xml", "example2_no_nonmatching.xml", "...")
