...
params:
  ...
  ## manually set plate ID if desired, otherwise plate ID will be 
...
# make directory -- we will put the file in the figures directory
dir.create("./figures")
...
write.csv(detect_output_table, './figures/target_detectability_table.csv')
```
