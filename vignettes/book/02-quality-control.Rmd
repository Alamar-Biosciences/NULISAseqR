...
**LOD of specific targets**: Most LODs for the targets in the panel represent the lower limit of detection. There are some exception:
...
Detectability is not a concern given the high level of these targets and the NPQ values can still be used for secondary data analysis. For novel sample types other than listed sample matrices, however, the algorithm may not be applicable depending on the abundance levels of the analyte, and the NPQ will not be reported. 
