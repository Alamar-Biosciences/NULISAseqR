...
for( i in 1:length(runs)){
  ...
  cat(knitr::kable(qcPlate, caption=paste0("Plate ", as.character(i), ": Plate QC Flag Summary"), 
...
for( i in 1:length(runs)){
  ...
  cat(knitr::kable(qcSample, caption=paste0("Plate ", as.character(i), ": Sample QC Flag Summary"), 
                   align='r', format.args=list(big.mark = ",", digits=2), table.attr=table.attr) %>%
        kable_styling(bootstrap_options = c("striped", "hover", "condensed"), full_width = TRUE))
}
```
